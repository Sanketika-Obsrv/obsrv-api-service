...
import { setResmsgid } from "../middlewares/setResmsgid";
...
router.post("/v1/datasets/create", setApiId("api.datasets.create"), onRequest({ entity: Entity.Management }), setResmsgid, DatasetCreate)
...
router.post('/v1/template/create/:templateName', setApiId("query.template.create"), onRequest({ entity: Entity.Management }), createQueryTemplate);
